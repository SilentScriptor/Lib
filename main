...
class ModernLibraryApp:
    def __init__(self, page: ft.Page):
        self.page = page
        self.page.title = "Library Management System"
        self.page.theme_mode = ft.ThemeMode.DARK
        self.page.padding = 0
        self.page.bgcolor = "#0d1117"
        
        # Cleaner, more minimal colors
        ...
        sidebar = ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ...
                                ft.Text("Management", size=11, color="white50"),
                            ],
                    ...
                    # Navigation
                    self.create_nav_button("🏠", "Dashboard", "home", True),
                    self.create_nav_button("📂", "Genres", "genres", False),
                    self.create_nav_button("📖", "Books", "books", False),
                    self.create_nav_button("👥", "Members", "members", False),
                    self.create_nav_button("🔄", "Transactions", "transactions", False),
                    self.create_nav_button("🔍", "Search", "search", False),
                    self.create_nav_button("📊", "Reports", "reports", False),
            ...
            [
                ...
                ft.Column(
                    [
                        ...
                        ft.Text(f"Welcome back • {datetime.now().strftime('%B %d, %Y')}", 
                               size=13, color="white50"),
                    ],
                    spacing=5,
                ),
                ...
                ft.ResponsiveRow(
                    [
                        ...
                        ft.Container(
                            col={"sm": 12, "md": 6, "lg": 3},
                            content=self.create_stat_card(
                                "📖", "Active Loans", str(active_borrows), 
        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Text(label, size=13, color="white60"),
                ],
                spacing=5,
            ),
        ...
        return ft.Container(
            content=ft.Column(
                [
                    ...
                    ft.Text(subtitle, size=12, color="white60"),
                ],
            ),
            bgcolor=self.card_bg,
    ...
    def create_genres_view(self):
        ...
        return ft.Column(
            [
                ft.Text("📂 Genre Management", size=32, weight=ft.FontWeight.BOLD),
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ft.Text("✨ Add New Genre", size=20, weight=ft.FontWeight.BOLD),
                            ft.Container(height=15),
                            ft.Row(
                                [
                ...
                ft.Container(height=30),
                ft.Text("📋 Genres List", size=24, weight=ft.FontWeight.BOLD),
                ft.Container(height=10),
    ...
    def add_genre(self, e):
        ...
        if not code or not name:
            self.show_snackbar("❌ Please fill all fields!", self.danger_color)
            return
        
        if len(code) != 2 or not code.isdigit():
            self.show_snackbar("❌ Code must be 2 digits!", self.danger_color)
            return
        
        try:
            self.cursor.execute("INSERT INTO genres VALUES (?, ?)", (code, name))
            self.conn.commit()
            self.show_snackbar(f"✅ Genre '{name}' added successfully!", self.success_color)
            self.genre_code_field.value = ""
            self.genre_name_field.value = ""
            self.refresh_genres()
            self.page.update()
        except sqlite3.IntegrityError:
            self.show_snackbar("❌ Code or name already exists!", self.danger_color)
    ...
    def refresh_genres(self):
        ...
        if not genres:
            self.genre_list_container.controls.append(
                ft.Container(
                    content=ft.Text(
                        "No genres yet. Add your first one! 🚀", 
                        size=16, 
                        color="grey",
    ...
    def delete_genre(self, code):
        ...
        def confirm_delete(e):
            try:
                ...
                self.conn.commit()
                self.show_snackbar("✅ Genre deleted!", self.success_color)
                self.refresh_genres()
                dialog.open = False
                self.page.update()
            except Exception as ex:
                self.show_snackbar("❌ Cannot delete! Genre has books.", self.danger_color)
                dialog.open = False
                self.page.update()
    ...
    def create_books_view(self):
        ...
        return ft.Column(
            [
                ft.Text("📖 Books Management", size=32, weight=ft.FontWeight.BOLD),
                ft.Container(height=20),
                ...
                ft.Container(height=30),
                ft.Text("📚 Books Library", size=24, weight=ft.FontWeight.BOLD),
                ft.Container(height=10),
    ...
    def add_book(self, e):
        ...
        if not name or not author or not genre or genre == "No genres":
            self.show_snackbar("❌ Please fill required fields!", self.danger_color)
            return
        ...
        try:
            ...
            self.conn.commit()
            self.show_snackbar(f"✅ Book added! Code: {book_code}", self.success_color)
            ...
            self.show_snackbar(f"❌ Error: {str(ex)}", self.danger_color)
                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ...
                                ft.Row(
                                    [
                                        ft.Text(f"📅 {year or 'N/A'}", size=12, color="white70"),
                                        ft.Text("•", color="grey"),
                                        ft.Text(f"📂 {genre_code}", size=12, color="white70"),
                                        ft.Text("•", color="grey") if publisher else ft.Container(),
                                        ft.Text(f"🏢 {publisher}", size=12, color="white70") if publisher else ft.Container(),
                                    ],
                                    spacing=5,
                                ),
                            ],
    ...
    def delete_book(self, code):
        ...
        def confirm_delete(e):
            try:
                ...
                self.conn.commit()
                self.show_snackbar("✅ Book deleted!", self.success_color)
                self.refresh_books()
                dialog.open = False
                self.page.update()
            except Exception as ex:
                self.show_snackbar("❌ Cannot delete! Book is borrowed.", self.danger_color)
                dialog.open = False
                self.page.update()
    ...
    def create_members_view(self):
        ...
        return ft.Column(
            [
                ft.Text("👥 Members Management", size=32, weight=ft.FontWeight.BOLD),
                ft.Container(height=20),
                ...
                ft.Container(
                    content=ft.Column(
                        [
                            ft.Text("✨ Register New Member", size=20, weight=ft.FontWeight.BOLD),
                            ft.Container(height=15),
                            ft.ResponsiveRow(
                                [
                ...
                ft.Container(height=30),
                ft.Text("📋 Members Directory", size=24, weight=ft.FontWeight.BOLD),
                ft.Container(height=10),
    ...
    def add_member(self, e):
        ...
        if not name:
            self.show_snackbar("❌ Please enter member name!", self.danger_color)
            return
        ...
        try:
            ...
            self.conn.commit()
            self.show_snackbar(f"✅ Member added! Code: {member_code}", self.success_color)
    ...
    def refresh_members(self):
        ...
        if not members:
            self.members_list_container.controls.append(
                ft.Container(
                    content=ft.Text(
                        "No members yet. Register the first one! 👤",
                        size=16,
                        color="grey",
                        text_align=ft.TextAlign.CENTER,
                    ),
                    ...
                    ft.Container(
                        content=ft.Column(
                            [
                                ...
                                ft.Row(
                                    [
                                        ft.Text(f"📱 {phone or 'N/A'}", size=12, color="white70") if phone else ft.Container(),
                                        ft.Text("•", color="grey") if phone and email else ft.Container(),
                                        ft.Text(f"📧 {email or 'N/A'}", size=12, color="white70") if email else ft.Container(),
                                    ],
                                    spacing=5,
                                ),
                                ft.Text(f"📅 Joined: {join_date}", size=12, color="grey"),
                            ],
                            spacing=8,
                        ),
                        bgcolor=self.card_bg,
    ...
    def delete_member(self, code):
        ...
        def confirm_delete(e):
            try:
                ...
                self.conn.commit()
                self.show_snackbar("✅ Member deleted!", self.success_color)
                self.refresh_members()
                dialog.open = False
                self.page.update()
            except Exception as ex:
                self.show_snackbar("❌ Cannot delete! Member has active loans.", self.danger_color)
                dialog.open = False
                self.page.update()
    ...
    def create_transactions_view(self):
        ...
        return ft.Column(
            [
                    ...
                    [
                        ...
                        ft.Container(
                            ...
                            content=ft.Container(
                                content=ft.Column(
                                    [
                                        ft.Text("📚 Borrow Book", size=20, weight=ft.FontWeight.BOLD),
                                        ft.Container(height=15),
                        ...
                        ft.Container(
                            ...
                            content=ft.Container(
                                content=ft.Column(
                                    [
                                        ft.Text("↩️ Return Book", size=20, weight=ft.FontWeight.BOLD),
                                        ft.Container(height=15),
                ...
                ft.Container(height=30),
                ft.Text("📋 Active Loans", size=24, weight=ft.FontWeight.BOLD),
                ft.Container(height=10),
    ...
    def borrow_book(self, e):
        ...
        if not member_code or not book_code:
            self.show_snackbar("❌ Please enter both codes!", self.danger_color)
            return
        
        # Verify member
        self.cursor.execute("SELECT * FROM members WHERE member_code = ?", (member_code,))
        if not self.cursor.fetchone():
            self.show_snackbar("❌ Member not found!", self.danger_color)
            return
        
        # Verify book
        self.cursor.execute("SELECT * FROM books WHERE book_code = ?", (book_code,))
        if not self.cursor.fetchone():
            self.show_snackbar("❌ Book not found!", self.danger_color)
            return
        ...
        if self.cursor.fetchone():
            self.show_snackbar("❌ Book is already borrowed!", self.danger_color)
            return
        ...
        try:
            ...
            self.conn.commit()
            self.show_snackbar(f"✅ Book borrowed! Due: {due_date}", self.success_color)
    ...
    def return_book(self, e):
        ...
        if not book_code:
            self.show_snackbar("❌ Please enter book code!", self.danger_color)
            return
        ...
        if not result:
            self.show_snackbar("❌ Book is not currently borrowed!", self.danger_color)
            return
        ...
        try:
            ...
            if fine > 0:
                self.show_snackbar(f"✅ Book returned! Fine: Rp {fine:,}", self.warning_color)
            else:
                self.show_snackbar("✅ Book returned on time!", self.success_color)
                        ...
                        content=ft.Column(
                            [
                                ft.Row(
                                    [
                                        ft.Container(
                                            content=ft.Text("⚠️ OVERDUE" if is_overdue else "✅ ACTIVE", 
                                ...
                                ft.Text(f"👤 {member_name} ({member_code})", size=12, color="white70"),
                                ft.Row(
                                    [
                                        ft.Text(f"📖 {book_code}", size=12, color="white70"),
                                        ft.Text("•", color="grey"),
                                        ft.Text(f"📅 Due: {due_date}", size=12, color="white70"),
                                        ft.Text("•", color="grey") if fine > 0 else ft.Container(),
                                        ft.Text(f"💰 Fine: Rp {fine:,}", size=12, color=self.danger_color) if fine > 0 else ft.Container(),
                                    ],
                                    spacing=5,
                                ),
                            ],
    ...
    def create_search_view(self):
        ...
        return ft.Column(
            [
                ft.Text("🔍 Search", size=32, weight=ft.FontWeight.BOLD),
                ft.Container(height=20),
                ...
                ft.Row(
                    [
                        ft.FilledTonalButton("📚 All Books", on_click=lambda _: self.search_all_books()),
                        ft.FilledTonalButton("👥 All Members", on_click=lambda _: self.search_all_members()),
                        ft.FilledTonalButton("📖 Available Books", on_click=lambda _: self.search_available_books()),
                    ],
                    spacing=10,
                    wrap=True,
                ),
    ...
    def perform_search(self):
        ...
        if not query:
            self.show_snackbar("❌ Please enter search term!", self.danger_color)
            return
        ...
        if books:
            self.search_results_container.controls.append(
                ft.Text(f"📚 Books ({len(books)})", size=18, weight=ft.FontWeight.BOLD)
            )
            for book in books:
                code, name, author, publisher, year, genre_code = book
                self.search_results_container.controls.append(
                    ft.Container(
                        content=ft.Column(
                            [
                                ...
                                ft.Text(f"by {author} • Code: {code}", size=12, color="grey"),
                            ],
                        ),
                        bgcolor=self.card_bg,
                        border_radius=10,
        ...
        if members:
            ...
            self.search_results_container.controls.append(
                ft.Text(f"👥 Members ({len(members)})", size=18, weight=ft.FontWeight.BOLD)
            )
            for member in members:
                code, name, phone, email, address, join_date = member
                self.search_results_container.controls.append(
                    ft.Container(
                        content=ft.Column(
                            [
                                ft.Text(name, size=15, weight=ft.FontWeight.BOLD),
                                ft.Text(f"Code: {code} • {phone or 'No phone'}", size=12, color="grey"),
                            ],
                        ),
                        bgcolor=self.card_bg,
                        border_radius=10,
    ...
    def search_all_books(self):
        ...
        self.search_results_container.controls.append(
            ft.Text(f"📚 All Books ({len(books)})", size=18, weight=ft.FontWeight.BOLD)
        )
    ...
    def search_all_members(self):
        ...
        self.search_results_container.controls.append(
            ft.Text(f"👥 All Members ({len(members)})", size=18, weight=ft.FontWeight.BOLD)
        )
            ...
            self.search_results_container.controls.append(
                ft.Container(
                    content=ft.Column(
                        [
                            ft.Text(name, size=15, weight=ft.FontWeight.BOLD),
                            ft.Text(f"Code: {code} • Joined: {join_date}", size=12, color="grey"),
                        ],
                    ),
                    bgcolor=self.card_bg,
                    border_radius=10,
    ...
    def search_available_books(self):
        ...
        self.search_results_container.controls.append(
            ft.Text(f"📚 Available Books ({len(books)})", size=18, weight=ft.FontWeight.BOLD)
        )
                        ...
                        [
                            ft.Row(
                                [
                                    ...
                                    ft.Container(
                                        content=ft.Text("✅ Available", size=10),
                                        bgcolor=self.success_color,
                                        padding=5,
                                        border_radius=5,
                                    ),
    ...
    def create_reports_view(self):
        ...
        return ft.Column(
            [
                ft.Text("📊 Reports & Analytics", size=32, weight=ft.FontWeight.BOLD),
                ft.Container(height=30),
